...
<html>
    ...
    <body>
        ...
        <br>
        <h3 align="center"><a class="text-warning " align="center" href="index.jsp" >Ir al Formulario Empleados...</a></h3>
        <br>
        <br>
        <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#modal_cliente" onclick="limpiar()">Nuevo</button>
        <br>
        <div class="container">
