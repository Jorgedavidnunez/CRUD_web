...
<html>
    ...
    <body>
        ...
        <br>
        <h3 align="center"><a class="text-warning " align="center" href="clientes.jsp" >Ir al Formulario Clientes...</a></h3>
        <br>
        <br>
        <button type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#modal_empleado" onclick="limpiar()">Nuevo</button>
        <br>
        <div class="container">
